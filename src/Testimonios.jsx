        ...
        <section className="text-cafe-dark body-font">
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="flex flex-wrap -m-4">
                    ...
                    />
                    <Testimonio
                        name='Nala Martínez Osornio'
                        job='Princesa y estupida a la vez'
                        testify='Barr barrbarr barrbarrbarr barr barr barrbarr barrbarr barrbarr barr'
                    />
                    <Testimonio
                        name='Rony Martínez Osornio'
                        job='Animal hermoso'
                        testify='Barr barrbarr barrbarrbarr barr barr barrbarr barrbarr barrbarr barr'
                    />
...
const Testimonio = ({ name, job, testify }) => <div className="p-4 md:w-1/2 w-full">
    <div className="h-full bg-cafe-ligth p-8 rounded-lg">
        ...
        <p className="leading-relaxed text-rosa-dark mb-6">{testify}</p>
