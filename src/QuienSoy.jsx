                ...
                <div className="flex flex-col sm:flex-row mt-10">
                    ...
                    {/* IMAGEN */}
                        ...
                        <div className="flex flex-col items-center text-center justify-center">
                            <h2 className="font-medium  mt-4 text-cafe-dark script-font text-3xl">L.N. Susan Areli Osornio Guzmán</h2>
                    ...
                    <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-green-800 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                        <p className="leading-relaxed text-lg mb-4 ">
                            <span className='script-font text-3xl'>Soy </span> apasionada de ayudar a la persona a que crea en ella y que mejore su relación con la comida , su imagen corporal y sus hábitos para contribuir a su bienestar.
                            </p>
                        <p className="leading-relaxed text-lg mb-4 ">
